...
<head>
	...
	<link rel="shortcut icon" href="assets/images/aeki_favicon.png">
...
<body class="home">
	...
	<div class="navbar navbar-inverse navbar-fixed-top headroom" >
		<div class="container">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="index.php"><img src="assets/images/aeki_logo_resize.png" alt="Progressus HTML5 template"></a>
			</div>
			<div class="navbar-collapse collapse">
				<ul class="nav navbar-nav pull-right">
					<li class="active"><a href="index.php">Produits</a></li>
	...
	<header id="head">
		<div class="container">
			<div class="row">
				<h1 class="lead">Les meubles à bon prix</h1>
